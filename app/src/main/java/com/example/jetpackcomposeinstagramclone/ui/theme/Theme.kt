package com.example.jetpackcomposeinstagramclone.ui.theme
...
@Composable
fun JetpackComposeInstagramCloneTheme(darkTheme: Boolean = isSystemInDarkTheme(), dynamicColor: Boolean = false, content: @Composable () -> Unit) {
